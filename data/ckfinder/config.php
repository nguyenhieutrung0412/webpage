...
$project_main = '/';
if($domainName=='http://localhost' || $domainName=='http://127.0.0.0'){
	$str1_arr = explode("/",$project);
	$project_main = '/'.$str1_arr[1].'/';
}
...
{	
	...
	return isset($_SESSION['admin_login']['username']);
	return false;
}
...
$baseUrl = $domainName.$project_main."data/";
/*
