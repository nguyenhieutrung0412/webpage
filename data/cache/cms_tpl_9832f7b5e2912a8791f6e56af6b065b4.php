...
<div class="form"><form action="" method="post" enctype="multipart/form-data" name="fcontent" id="fcontent">
  <table width="100%" border="0" cellspacing="0" cellpadding="1" class="table-Form1">
    <tr>
      <td width="84%"><strong>'.(isset($this->_data["."][0]['name'])?$this->_data["."][0]['name']:'').'</strong>&nbsp;<br>
      <em>'.(isset($this->_data["."][0]['note'])?$this->_data["."][0]['note']:'').'</em></td>
    </tr>
    <tr>
      <td>'.(isset($this->_data["."][0]['value'])?$this->_data["."][0]['value']:'').'</td>
    </tr>
  </table>
