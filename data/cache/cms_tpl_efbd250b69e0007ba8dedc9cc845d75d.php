  ...
  <div style="height: 200px; overflow:auto;">
	<table width="100%" border="0" cellspacing="1" cellpadding="1" class="table_list list marginTop5">
          ...
          <tr class="clear_product tr_content2" id="'.(isset($this->_data["product."][$i]["id"])?$this->_data["product."][$i]["id"]:'').'pro">
            <td width="3%"><img src="template/images/icons_default/file.gif" alt="" width="16" height="16" /></td>
            <td width="97%">'.(isset($this->_data["product."][$i]["name"])?$this->_data["product."][$i]["name"]:'').'</td>
          </tr>';}}$_tpl .= '
	...
	<input type="button" value="Yes" onclick="options_empty('.(isset($this->_data["."][0]['type'])?$this->_data["."][0]['type']:'').');" />&nbsp;
