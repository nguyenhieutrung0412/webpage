...
<div class="form"><form action="" method="post" enctype="multipart/form-data" name="fcontent" id="fcontent">
  <table width="100%" border="0" cellspacing="1" cellpadding="1" class="table-Form1">
    <tr>
      <td>&nbsp;</td>
      <td>'.(isset($this->_data["."][0]['error'])?$this->_data["."][0]['error']:'').'</td>
    </tr>
    <tr>
      <td width="13%">Code</td>
      <td width="87%"><input name="code" type="text" id="code" value="'.(isset($this->_data["."][0]['code'])?$this->_data["."][0]['code']:'').'"></td>
    </tr>
    <tr>
      <td>Name</td>
      <td><input name="name" type="text" id="name" value="'.(isset($this->_data["."][0]['name'])?$this->_data["."][0]['name']:'').'"></td>
    </tr>
    <tr>
      <td>Value</td>
      <td><input name="value" type="text" id="value" value="'.(isset($this->_data["."][0]['value'])?$this->_data["."][0]['value']:'').'"></td>
    </tr>
    <tr>
      <td>Notes</td>
      <td><textarea name="note" id="note">'.(isset($this->_data["."][0]['note'])?$this->_data["."][0]['note']:'').'</textarea></td>
    </tr>
  </table>
  <div class="table_list" align="right">
	...
	<input name="back" type="button" class="btn btn_cancel" id="back" value="'.(isset($this->merge['lang']['cancel'])?$this->merge['lang']['cancel']:'').'" onClick="location.href=\''.(isset($this->_data["."][0]['http_referer'])?$this->_data["."][0]['http_referer']:'').'\';">
  </div>
</form></div>
<script type="text/javascript">
	var opt = {
