...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname)
{
      ...
      $smtp_host ='mail.timkiemvanphong.net';//Dia chi mail server
      $admin_email = 'admin@timkiemvanphong.net';//User duoc khai bao tren mail server
      $smtp_username = 'admin@timkiemvanphong.net';//User duoc khai bao tren mail server
      $smtp_password = 'Ey&;uq,GgDmZ';//Pass cua email nay
