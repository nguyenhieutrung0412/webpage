...
//Cách dùng: https://github.com/serbanghita/Mobile-Detect/wiki/Code-examples
...
//print_r($mobile_detect->isIphone());
//print_r($mobile_detect->isTablet());
//print_r($mobile_detect->isiOS());